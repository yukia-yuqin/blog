...
第三步：当认证服务器验证通过之后，根据请求参数service的值，进行重定向，其实就是回到了请求的后端，同时会携带一个ticket令牌参数。同时会在Cookie中设置一个TGC，该cookie是网站认证系统cas.xiaogui.com的cookie，只有访问这个网站才会携带这个cookie过去。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNzYxNzI3ODIsNjQxMzI5MzU4LC0xOT
